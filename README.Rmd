...
```{bash, eval=FALSE}
module add python/anaconda3-2021.05-3.8.8
source activate cia # if needed, define user-specific python environment
python Python/scVI_v0.7.1.py --help
```
...
This code can also be used for ranking of URs involved in inter-organ interactions, all interactions, or for individual organs separately, by specifying the different parameters; 'ints': (str) inter, intra, or all, and 'Tis': (str) all (default), Joint, Lung, Muscle, Skin, or Spleen. The parameter 'ann_colors_in' is also optional, for specifying preferred color scheme for cell types and organs.    
