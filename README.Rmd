...
dir.clust <- './data/clustering_and_celltype_identification'
clusts <- read.csv(list.files(dir.clust, pattern = '^cluster_ids', full.names = T))
orth <- read.table('./data/orthologous_translation_file.txt')
DEGs <- read.csv('./data/DEG_analysis/sick_vs_healthy/change_mode/subset_significant/DEGs_Sick_vs_Healthy.csv')

NicheNet_analysis(data=exprdata, clusts, orth, DEGs)
