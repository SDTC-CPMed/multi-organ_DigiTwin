---
title: "IPA analyses"
author: "Xinxiu Lee, Sandra Lilja, Martin Smelik, Danuta Gawel"
date: "29/04/2022"
output: 
  html_document:
    toc: true
...
To reproduce the analyses for generation of curation file, pathway analysis, and prediction of upstream regulators (URs) from our project ([CIA analysis](tutorial_CIA-analyses.html) and [IMIDs analysis](tutorial_IMIDs-analyses.html)), follow this pipeline.
...
![](./temp/images/ipa5.png){width=65%}

4. Click ”next”, to get to the settings.
    
![](./temp/images/ipa6.png){width=45%}
...
![](./temp/images/ipa10.png){width=65%}
